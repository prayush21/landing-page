                      ...
                      <div className="title">
                        <h3>
                          <Link href="/services/serviceSinglePage4">
                            Waterproofing Segment (3)
                          </Link>
                        </h3>
                        <p>
                          Get your medical device tested and into the hands of
                          your customers faster than ever before. Time to market
                          starts with partnership, and for more
                        </p>
                      </div>
                      <div className="read_more">
                        <Link href="/services/serviceSinglePage4">
