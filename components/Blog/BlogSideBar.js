                                    ...
                                    <div className="post has-post-thumbnail">
                                        ...
                                        <div className="content_holder">
                                            <div className="info_holder">
                                                <p>
                                                    <span className="t_author">By <Link href="https://frenify.com/" ink target="_blank" rel="noreferrer">Frenify</Link></span>
                                ...
                                <li>
                                    <div className="post has-post-thumbnail">
                                        ...
                                        <div className="content_holder">
                                            <div className="info_holder">
                                                <p>
                                                    <span className="t_author">By <Link href="https://frenify.com/" target="_blank" rel="noreferrer">Frenify</Link></span>
