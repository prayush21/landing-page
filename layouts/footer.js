                            ...
                            <div className="inner">
                                <ul className="widget_area">
                                    <li>
                                        <div className="item">
                                            <div className="logo">
                                                <Link href="/"><img src="/img/logo-light.png" alt="" /></Link>
                                            </div>
                    ...
                    <div className="container">
                        <div className="footer_bottom_in">
                            ...
                            <div className="footer_copyright">
                                <p>&copy; 1934 – 2021 Industify, LCC. All rights reserved. Theme has been developed by <Link href="https://themeforest.net/user/trendycoder" target="_blank" rel="noreferrer">TrendyCoder</Link></p>
                            </div>
